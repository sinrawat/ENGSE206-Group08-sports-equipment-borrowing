...
| US-03 | ผู้ยืม / ชมรม-ผู้จัดกิจกรรม | ยืมอุปกรณ์ที่ต้องการจากระบบ | เพื่อให้สามารถนำอุปกรณ์ไปใช้ในกิจกรรมของตนเองได้ | Must | *ยังไม่มีใน backlog (ต้องเพิ่ม)* | AC-03, AC-04 |
| US-04 | ผู้ยืม / ชมรม-ผู้จัดกิจกรรม | คืนอุปกรณ์ที่ยืมไปเมื่อใช้งานเสร็จ | เพื่อให้อุปกรณ์กลับเข้าสู่ระบบและพร้อมให้ผู้อื่นยืมต่อได้ | Must | *ยังไม่มีใน backlog (ต้องเพิ่ม)* | AC-05, AC-06 |
...
| UC-02 | ยืมอุปกรณ์ | ผู้ยืม, ชมรม/ผู้จัดกิจกรรม | ยืมอุปกรณ์ที่ต้องการไปใช้งาน | *ยังไม่มีใน backlog* | [`../diagrams/use-case/UC-02-v2.png`](../diagrams/use-case/UC-02-v2.png) |
| UC-03 | คืนอุปกรณ์ | ผู้ยืม, ชมรม/ผู้จัดกิจกรรม, ผู้ดูแลอุปกรณ์ | คืนอุปกรณ์ที่ยืมไปเมื่อใช้งานเสร็จ | *ยังไม่มีใน backlog* | [`../diagrams/use-case/UC-03-v2.png`](../diagrams/use-case/UC-03-v2.png) |
